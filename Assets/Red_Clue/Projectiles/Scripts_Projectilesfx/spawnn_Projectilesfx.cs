...
public class spawnn_Projectilesfx : MonoBehaviour
{
    public GameObject firepoint;
    public List<GameObject> fx = new List<GameObject>();
    public rotate_Projectilesfx rotate;
    ...
    void Update()
    {
        ...
        {
            timeToFire = Time.time + 1 / effectToSpawn.GetComponent<movee_Projectilesfx>().fireRate;
            SpawnVFX();
        }
